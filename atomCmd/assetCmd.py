...
class assetCmd(cmd):
    ...
    def _initParser(self, parser):
        ...
        self.parser.add_argument("--period", dest="period", type=float, help="Deprecation period, in years")
        self.parser.add_argument("--acct", dest="acct", choices=["A","B","C"], help="Main account")
