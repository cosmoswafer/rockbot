...
Total: **595 tests** across 3 crates (408 core + 164 user + 23 real + 1 flaky unit)
...
| **Real** | Live server tests (`#[ignore]` in `tests/`) requiring credentials | 23 | [real.md](real.md) |
...
| rockbot | 330 | 108 | 6 | **444** |
| webdav | 38 | 17 | 7 | **62** |
| **Total** | **408** | **164** | **23** | **595** |
