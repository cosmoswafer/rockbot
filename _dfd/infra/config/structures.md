# Configuration Management — Shared Structures
...
| `acp`        | `Option<AcpConfig>`          | ACP agent integration — see [ACP Delegate](../../tools/acp-delegate/main-path.md) §3 for the canonical `AcpConfig` table |
